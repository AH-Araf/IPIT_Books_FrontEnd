...
const ContactLocation = () => {
    return (
        <div className="lg:flex e justify-evenly items-center mt-10 bg-slate-100 py-6">
            <div data-aos="fade-right" data-aos-duration="2000" className="flex justify-center mb-4">
                <iframe
                    className="lg:w-[600px] w-11/12 h-96 rounded-xl e p-1 bg-red-200"
            ...
            <div data-aos="fade-left" data-aos-duration="2000" className="text-md ml-2">
